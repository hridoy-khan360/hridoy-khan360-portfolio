...
export default function ProductList() {
    ...
    // console.log(pd)
    useEffect(() => {
        const url = `https://boktiar-server.up.railway.app/post/getPost`;
        fetch(url)
        ...
        <div className="pl">
            <div data-aos="fade-up" className="pl-texts">
                <h1 className="pl-title">
                    Create & inspire. This is Hridoy
                </h1>
                <p className="pl-desc">
                Hridoy is a creative Developer and Designer that your work has been waiting for.
