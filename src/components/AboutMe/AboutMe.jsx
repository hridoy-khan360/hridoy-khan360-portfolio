...
import './AboutMe.css';
import me from '../../img/hridoy2.png';
                            ...
                            <div className="clleft">
                                <div className="card me-card" style={{ width: '18rem' }}>
                                    ...
                                    <div className="card-content">
                                        <h5 className="card-title">Hridoy khan
                                    ...
                                    <div className="card-bottom">
                                        <div className="card-media">
                                            <a href="https://twitter.com/mdhridoyk05" target="blank"  className="card-media-link"><i className="fa-brands fa-twitter me-icon"></i></a>
                                            {/* <Link to="https://twitter.com/mdhridoyk05" className="card-media-link"><i className="fa-brands fa-twitter me-icon"></i></Link> */}
                                            <a href="https://www.linkedin.com/in/hridoy-khan360/" target="blank"  className="card-media-link"><i className="fa-brands fa-linkedin me-icon"></i></a>
                                            <a href="https://www.instagram.com/hridoy_khan360/" target="blank" className="card-media-link"><i className="fa-brands fa-instagram me-icon"></i></a>
                                            <a href="https://www.facebook.com/mhk360" target="blank"  className="card-media-link"><i className="fa-brands fa-facebook me-icon"></i></a>
